...
var menus = &[]menuv1.Menu{
	...
	{ID: 17, ParentID: 2, Name: "后台用户管理", Sequence: 40, MenuType: 2, Code: "Admins", Icon: "user", OperateType: "none",URL: "/admins"},
	{ID: 18, ParentID: 17, Name: "新增", Sequence: 1, MenuType: 3, Code: "AdminsAdd", Icon: "", OperateType: "add",URL: "/admins/create"},
	{ID: 19, ParentID: 17, Name: "删除", Sequence: 2, MenuType: 3, Code: "AdminsDel", Icon: "", OperateType: "del",URL: "/admins/delete"},
	{ID: 20, ParentID: 17, Name: "查看", Sequence: 3, MenuType: 3, Code: "AdminsView", Icon: "", OperateType: "view",URL: "/admins/detail"},
	{ID: 21, ParentID: 17, Name: "编辑", Sequence: 4, MenuType: 3, Code: "AdminsUpdate", Icon: "", OperateType: "update",URL: "/admins/update"},
	{ID: 22, ParentID: 17, Name: "分页api", Sequence: 5, MenuType: 3, Code: "AdminsList", Icon: "", OperateType: "list",URL: "/admins/list"},
	{ID: 23, ParentID: 17, Name: "分配角色", Sequence: 6, MenuType: 3, Code: "AdminsSetrole", Icon: "", OperateType: "setadminrole",URL: "/admins/setrole"},
}
